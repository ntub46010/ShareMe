...
public class ProductHomeFrag extends Fragment {
    ...
    private void showData() {
        recyProduct = (RecyclerView) getView().findViewById(R.id.recyclerView);
        recyProduct.setHasFixedSize(true);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context);
        recyProduct.setLayoutManager(linearLayoutManager);

        myAdapter = new ProductDisplayAdapter(context, getResources(), books);
        myAdapter.setBackgroundColor(getResources(), R.color.card_product);
        recyProduct.setAdapter(myAdapter);
